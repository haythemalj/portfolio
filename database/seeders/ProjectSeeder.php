    ...
    public function run()
    {
        ...
        $projects = [
            ...
            [
                ...
                'details' => 'Focused on a premium visual identity, menu storytelling, and mobile-friendly layout decisions for a modern food brand.',
                'image' => '/images/projects/chinchin.jpg',
            ...
            [
                ...
                'details' => 'Designed a refined landing experience centered on food imagery, premium positioning, and conversion-focused CTA sections.',
                'image' => '/images/projects/chinchin.jpg',
            ...
            [
                ...
                'description' => 'A portfolio collection of business websites created for different industries, audiences, and growth goals.',
                'details' => 'Completed a multi-site project set focused on adaptable layouts, brand positioning, and conversion-oriented web experiences.',
                'image' => '/images/projects/chinchin.jpg',
                'github_url' => 'https://github.com/haythemalj',
